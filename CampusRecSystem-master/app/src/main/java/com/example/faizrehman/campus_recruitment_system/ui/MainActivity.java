...
public class MainActivity extends AppCompatActivity {
    ...
    private Button adminLogin,companyLogin,studentLogin,eventLogin;
   private   TextView signupText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventLogin = (Button)findViewById(R.id.event_login_btn);
        ...
        eventLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,LoginActivity.class);
                intent.putExtra("TAG","Event organiser");
                editor.putString("TAG","Event organiser");
                editor.commit();
                startActivity(intent);
            }
        });
    ...
    public void checkUser(final String uid,String usercheck){
        if(uid!=null) {
            ...
            else if(usercheck.matches("Event organiser")) {
